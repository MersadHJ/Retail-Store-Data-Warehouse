...
select max(StoreOrder_id_surrogateKey) as max_Key from Temp_Dim_StoreOrder
)
-- Temp_Update_StoreOrder_3 - New Data with Considering scd
insert into Temp_Update_StoreOrder_3

select max_Key + 2,t2.StoreOrder_ID,t2.Store_ID,t2.Store_Name,t2.Supplier_ID,t2.SupplierName ,t2.AddressField1,t2.AddressField2,
...
from Temp_Update_StoreOrder_2 as t2	inner join Temp_Dim_StoreOrder as td on ( t2.storeOrder_ID = td.storeOrder_ID), max_SurrogateKey
...
select max_Key + 2,t1.StoreOrder_ID,t1.Store_ID,t1.Store_Name,t1.Supplier_ID,t1.SupplierName ,t1.AddressField1,t1.AddressField2,
   t1.Country,t1.State,t1.City,t1.Zipcode,t1.Date,t1.Status,t1.[Total Payment],t1.StorePayment_ID,t1.PaymentMode
from Temp_Update_StoreOrder_1 as t1 inner join Temp_Update_StoreOrder_4 as t4 
on t1 .StoreOrder_ID = t4.StoreOrder_ID , max_SurrogateKey  
...
select * from Temp_Update_StoreOrder_5